            ...
            <Template account_type = 'admin'>
                <div className="row a-i-c">
                    <div className = 'col-12 mb-4'>
                        <h4 className = 'theme-color'>Courses</h4>
                    </div>
                    <div className = 'col-12'>
                        <div className = 'mb-5 text-right'>
                            <a href = {`./courses/new`} className = 'p-3 rounded-2x shadow bg-success text-white px-5 border-0'>Add course</a>
                        </div>
                        <div className = 'table-responsive rounded-2x shadow'>
                            <table className = 'table table-striped m-0 overflow-0'>
                                ...
                                <tbody className = 'table-light'>{
                                    ...
                                    ? (
                                        (courses.length > 0)
                                        ?   courses.map(({id, name, mda_name, access_code, description, status}, index) => (
                                            <tr className = 'text-capitalize' key = {id}>
                                                ...
                                                <td className = 'text-center'>
                                                    <a href = {`./courses/${id}`} className = 'underline theme-color'>
                                                        <span>see more</span>
